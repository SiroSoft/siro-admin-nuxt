export default {
  ...
  opensource: {
    ...
    visitSite: 'Visit sirophp.com',
    deployTitle: 'Deploy your own',
    deployDesc: 'Liked the demo? Grab the code and run it yourself.',
  },
  placeholders: {
    ...
    productSummary: 'Brief product summary',
  ...
  validation: {
    ...
    newPasswordMin: 'New password must be at least {{min}} characters',
    titleMin: 'Title must be at least {{min}} characters',
    roleRequired: 'Role is required',
    statusRequired: 'Status is required',
    skuRequired: 'SKU is required',
    priceRequired: 'Price is required',
    pricePositive: 'Price must be 0 or more',
    productRequired: 'Product is required',
    quantityMin: 'Quantity must be at least {{min}}',
